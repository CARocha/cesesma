# Django settings for cesesma project.
...
TEMPLATE_CONTEXT_PROCESSORS = (
    ...
    'cesesma.context.globales',
)

ROOT_URLCONF = 'cesesma.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'cesesma.wsgi.application'
...
SUIT_CONFIG = {
    'ADMIN_NAME': 'Administracion CESESMA',    
}
